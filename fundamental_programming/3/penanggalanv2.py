...
# {Realisasi dpm(B) sama dengan Penanggalan versi ke 1}
def IsKabisat(a):
...
# Aplikasi
A = Harike1900(5, 10, 20)
print(A)  # 279
B = Harike1900(9, 19, 40)
print(B)  # Bulan tidak valid
C = Harike1900(26, 12, 66)
print(C)  # 360
D = Harike1900(20, 11, 80)
print(D)  # 325
E = Harike1900(8, 12, 80)
print(E)  # 343
